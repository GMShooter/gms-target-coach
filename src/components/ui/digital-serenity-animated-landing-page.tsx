...
const DigitalSerenity = () => {
  ...
  useEffect(() => {
    ...
    const handleMouseEnter = (e: Event) => {
      if ((e.target as HTMLElement).style) (e.target as HTMLElement).style.textShadow = '0 0 20px rgba(203, 213, 225, 0.5)';
    };
    const handleMouseLeave = (e: Event) => {
      if ((e.target as HTMLElement).style) (e.target as HTMLElement).style.textShadow = 'none';
    };
    wordElements.forEach((word) => {
  ...
  const pageStyles = `
    ...
    .word-animate { display: inline-block; opacity: 0; margin: 0 0.05em; transition: color 0.3s ease, transform 0.3s ease; }
  ...
  return (
    <>
      ...
      <div className="min-h-screen animated-gradient text-slate-100 font-primary overflow-hidden relative">
        {/* Animated gradient overlay instead of Three.js canvas */}
        <div className="absolute inset-0 bg-gradient-to-br from-blue-900/20 via-purple-900/20 to-teal-900/20 animate-pulse" style={{ animationDuration: '8s' }}></div>
        ...
        <svg className="absolute inset-0 w-full h-full pointer-events-none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          <circle cx="20%" cy="20%" r="3" className="detail-dot" style={{ animationDelay: '3s' }} />
          <circle cx="80%" cy="20%" r="3" className="detail-dot" style={{ animationDelay: '3.2s' }} />
          <circle cx="20%" cy="80%" r="3" className="detail-dot" style={{ animationDelay: '3.4s' }} />
          <circle cx="80%" cy="80%" r="3" className="detail-dot" style={{ animationDelay: '3.6s' }} />
        ...
        <div className="relative z-10 min-h-screen flex flex-col justify-between items-center px-6 py-10 sm:px-8 sm:py-12 md:px-16 md:py-20">
          <div className="text-center">
            <h2 className="text-xs sm:text-sm font-mono font-light text-slate-300 uppercase tracking-[0.2em] opacity-80">
              <span className="word-animate" data-delay="0">Precision</span>
              <span className="word-animate" data-delay="300">matters.</span>
            </h2>
          ...
          <div className="text-center max-w-5xl mx-auto relative">
            ...
            <div className="mb-8 md:mb-12 flex justify-center">
              <img 
                ...
                alt="GMShoot Logo" 
                className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-56 lg:h-56 object-contain opacity-90 animate-pulse"
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extralight leading-tight tracking-tight text-slate-50 text-decoration-animate">
              <div className="mb-4 md:mb-6">
                <span className="word-animate inline-block" data-delay="700">Master</span>
                <span className="word-animate inline-block mx-2" data-delay="850">your</span>
                <span className="word-animate inline-block" data-delay="1000">aim,</span>
              </div>
              ...
              <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-thin text-slate-300 leading-relaxed tracking-wide">
                <span className="word-animate inline-block" data-delay="1400">where</span>
                <span className="word-animate inline-block mx-2" data-delay="1550">accuracy</span>
                <span className="word-animate inline-block mx-2" data-delay="1700">meets</span>
                <span className="word-animate inline-block mx-2" data-delay="1850">analysis</span>
                <span className="word-animate inline-block mx-2" data-delay="2000">and</span>
                <span className="word-animate inline-block mx-2" data-delay="2150">performance</span>
                <span className="word-animate inline-block mx-2" data-delay="2300">soars</span>
                <span className="word-animate inline-block mx-2" data-delay="2450">to</span>
                <span className="word-animate inline-block" data-delay="2600">excellence.</span>
              </div>
            </h1>
          ...
          <div className="text-center">
            ...
            <h2 className="text-xs sm:text-sm font-mono font-light text-slate-300 uppercase tracking-[0.2em] opacity-80">
              ...
              <span className="word-animate" data-delay="3200">improve,</span>
              <span className="word-animate" data-delay="3400">excel.</span>
            </h2>
            
            {/* CTA Button */}
            <div className="mt-8 opacity-0" style={{ animation: 'word-appear 1s ease-out forwards', animationDelay: '4.2s' }}>
              <Link 
                to="/login"
                className="inline-flex items-center px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-blue-500/25"
              >
                Get Started
