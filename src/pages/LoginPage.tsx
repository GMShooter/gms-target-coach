  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-black flex items-center justify-center p-4">
      ...
      <div className="absolute top-8 left-8">
        <img src="/GMShoot_logo.png" alt="GMShoot" className="h-12 w-auto" />
      </div>

      {/* Login Form */}
      <div className="w-full max-w-md">
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50">
          <h1 className="text-3xl font-bold text-white mb-2 text-center">GMShoot</h1>
          <p className="text-slate-400 mb-8 text-center">Sign in to access the demo</p>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full bg-slate-700 hover:bg-slate-600 text-white font-medium py-3 px-4 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
          >
