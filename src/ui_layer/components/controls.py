    ...
    def render_configuration_section(self) -> Dict[str, Any]:
        ...
        try:
            ...
            outlier_method = st.sidebar.selectbox(
                ...
                index=["None", "Standard Deviation", "IQR", "Convex Hull"].index(
    ...
    def render_status_section(self) -> None:
        ...
        try:
            ...
            if current_image is not None:
                st.sidebar.image(current_image, width=200, caption="Current Image")
            ...
            st.sidebar.write(f"Created: {state_manager.get_session_created_at()[:10]}")
    ...
    def render_help_section(self) -> None:
        ...
        try:
            ...
            with st.sidebar.expander("Help & Info"):
                ...
                **Configuration:**
                - **Duplicate Threshold**: Distance in pixels to consider shots as duplicates
                - **Minimum Confidence**: Filter out shots below this confidence level
