...
const LandingPage = () => {
  ...
  useEffect(() => {
    const animateWords = () => {
      const wordElements = document.querySelectorAll('.word-animate') as NodeListOf<HTMLElement>;
  ...
  useEffect(() => {
    ...
    const handleMouseEnter = (e: MouseEvent) => {
      if (e.target instanceof HTMLElement) e.target.style.textShadow = '0 0 20px rgba(203, 213, 225, 0.5)';
    };
          ...
          <div className="text-center max-w-5xl mx-auto relative">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extralight leading-tight tracking-tight text-slate-50 text-decoration-animate">
              <div className="mb-4 md:mb-6">
                <span className="word-animate" data-delay="700">Master</span>
                <span className="word-animate" data-delay="850">your</span>
                <span className="word-animate" data-delay="1000">shot,</span>
              </div>
              ...
              <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-thin text-slate-300 leading-relaxed tracking-wide">
                ...
                <span className="word-animate" data-delay="1550">accuracy</span>
                <span className="word-animate" data-delay="1700">meets</span>
                <span className="word-animate" data-delay="1850">analysis</span>
                <span className="word-animate" data-delay="2000">and</span>
                <span className="word-animate" data-delay="2150">performance</span>
                <span className="word-animate" data-delay="2300">reaches</span>
                <span className="word-animate" data-delay="2450">its</span>
                <span className="word-animate" data-delay="2600">peak.</span>
              </div>
            </h1>
