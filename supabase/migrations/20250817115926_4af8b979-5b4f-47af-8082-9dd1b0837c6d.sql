-- Fix security warnings by updating RLS policies
...
-- Update sessions table RLS policies - remove null user_id allowance for public access
...
-- Update shots table RLS policies - remove null user_id allowance
...
-- Make user_id NOT NULL in sessions table to enforce proper data integrity
